...
namespace QuanLyKhachSan.Services
{
    public class DanhMucService
    {
        ...
        public KetQuaXuLy ThemNhanVien(string ma, string ten, string vaiTro, string sdt)
        {
            ...
            try
            {
                Db.Execute("INSERT INTO NhanVien VALUES(@m,@t,@v,@s)", new SqlParameter("@m", ma), new SqlParameter("@t", ten), new SqlParameter("@v", vaiTro), new SqlParameter("@s", (object)sdt ?? DBNull.Value));
        ...
        public KetQuaXuLy ThemDichVu(string ma, string ten, string dvt, decimal gia)
        {
            ...
            try
            {
                Db.Execute("INSERT INTO DichVu VALUES(@m,@t,@d,@g)", new SqlParameter("@m", ma), new SqlParameter("@t", ten), new SqlParameter("@d", dvt), new SqlParameter("@g", gia));
        ...
        public KetQuaXuLy ThemQuyDinh(string ma, string loai, string muc, decimal tien)
        {
            ...
            try
            {
                Db.Execute("INSERT INTO QuyDinhDenBu VALUES(@m,@l,@u,@t)", new SqlParameter("@m", ma), new SqlParameter("@l", loai), new SqlParameter("@u", muc), new SqlParameter("@t", tien));
